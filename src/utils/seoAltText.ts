...
const productTypeNames = {
  tr: {
    ...
    'tree-root': 'Ağaç Kökü Parçalama Makinesi',
    'wood': 'Ağaç Parçalama Öğütme Makinesi',
  ...
  en: {
    ...
    'harddisk': 'Hard Disk Destroyer',
    'tree-root': 'Tree Root Shredder',
    'wood': 'Wood Grinding Machine',
    'glass': 'Glass Bottle Crusher',
  ...
  ru: {
    ...
    'harddisk': 'Уничтожитель жестких дисков',
    'tree-root': 'Измельчитель корней деревьев',
    'wood': 'Измельчитель древесины',
    'glass': 'Дробилка стеклянных бутылок',
  ...
  ar: {
    ...
    'harddisk': 'آلة تدمير الأقراص الصلبة',
    'tree-root': 'آلة تقطيع جذور الأشجار',
    'wood': 'آلة طحن الخشب',
    'glass': 'آلة تكسير الزجاج',
...
export function generateProductAltText(config: AltTextConfig): string {
  ...
  const productName = (productTypeNames[language] as Record<string, string>)?.[productType] || productType;
...
export function generateWasteAltText(
  ...
  return (wasteNames[language] as Record<string, string>)?.[wasteType] || wasteType;
}
