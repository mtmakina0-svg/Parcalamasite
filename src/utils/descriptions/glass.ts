...
export const glassDescriptions: { [modelName: string]: MultilingualModelDescription } = {
    'CK-200': {
        tr: {
            ...
            paragraph2: 'Entegre sıvı ayrıştırma haznesi sayesinde, dolu veya yarım dolu şişelerin içindeki sıvılar güvenli bir şekilde alt hazneye süzülür ve drenaj sistemi ile tahliye edilir. Korozyona dayanıklı bileşenler ve özel alaşımlı cam kırma çekiçleri ile uzun ömürlü kullanım sunar. Tekerlekli mobil tasarımı sayesinde tesis içinde kolayca taşınabilir.',
            paragraph3: 'MT Makina CK-200, atık toplama maliyetlerini düşürmek ve çevre dostu "Sıfır Atık" hedeflerini tutturmak isteyen HORECA sektörü için idealdir. Tak-çalıştır özelliği, basit kullanımı ve bakım gerektirmeyen yapısı ile operasyonel yük getirmez. CE sertifikası ve iş güvenliği sensörleri ile tam koruma sağlar.'
        },
        en: {
            ...
            paragraph1: 'CK-200 model has 200 mm rotor width with 1.5-3 kW optimized motor power. It can crush approximately 600-800 glass bottles per hour with a processing capacity of 100-200 kg/hour. Thanks to its low noise level (65-70 dB), it works without disturbance in points close to customer areas, behind kitchens or in hotel service corridors. Saves storage space by reducing waste glass volume by 80%.',
            paragraph2: 'Thanks to the integrated liquid separation chamber, liquids inside full or half-full bottles are safely drained to the lower chamber and discharged via drainage system. Offers long-lasting use with corrosion-resistant components and special alloy glass crushing hammers. Can be easily moved within the facility thanks to its wheeled mobile design.',
            paragraph3: 'MT Makina CK-200 is ideal for the HORECA sector wanting to reduce waste collection costs and meet environmentally friendly "Zero Waste" targets. Brings no operational burden with plug-and-play feature, simple operation and maintenance-free structure. Provides full protection with CE certificate and occupational safety sensors.'
        },
        ru: {
            ...
            paragraph1: 'Модель CK-200 имеет ширину ротора 200 мм с оптимизированной мощностью двигателя 1,5-3 кВт. Может измельчать около 600-800 стеклянных бутылок в час при производительности 100-200 кг/час. Благодаря низкому уровню шума (65-70 дБ) работает без помех в точках, близких к клиентским зонам. Экономит место для хранения, уменьшая объем отходов стекла на 80%.',
            paragraph2: 'Благодаря встроенной камере разделения жидкости, жидкости внутри полных или наполовину полных бутылок безопасно сливаются в нижнюю камеру и удаляются через дренажную систему. Обеспечивает длительное использование с коррозионно-стойкими компонентами и молотками для дробления стекла из специального сплава. Легко перемещается внутри объекта благодаря мобильной конструкции на колесах.',
            paragraph3: 'MT Makina CK-200 идеально подходит для сектора HORECA, желающего сократить расходы на сбор отходов и достичь экологически чистых целей "Ноль отходов". Не несет эксплуатационной нагрузки благодаря функции plug-and-play, простой эксплуатации и не требующей обслуживания конструкции. Обеспечивает полную защиту с сертификатом CE и датчиками безопасности труда.'
        },
        ar: {
