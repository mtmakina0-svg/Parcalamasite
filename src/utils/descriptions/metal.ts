...
export const metalDescriptions: { [modelName: string]: MultilingualModelDescription } = {
    'RDM-100': {
        tr: {
            intro: 'RDM-100 Redmonster metal parçalama makinesi, küçük ve orta ölçekli metal geri dönüşüm tesisleri için tasarlanmış kompakt ve güçlü bir çözümdür.',
            paragraph1: 'RDM-100 model metal parçalama makinesi, 75 kW yüksek torklu motor gücü ile 1000 mm rotor uzunluğu ve metal parçalama için özel tasarlanmış bıçak yapısına sahiptir. 1500-2500 kg/saat işleme kapasitesi ile alüminyum profiller, bakır kablolar, elektronik atıklar, metal talaşlar ve hafif çelik atıkların parçalanmasında etkilidir. Kompakt tasarımı sayesinde dar alanlarda bile yüksek verimlilik sağlar. Düşük devir yüksek tork prensibi, metal parçalamada maksimum güç sağlar.',
            paragraph2: 'PLC kontrollü otomasyon sistemi, otomatik sıkışma önleme özelliği ve aşırı yük koruması ile donatılmış RDM-100, güvenli ve sürekli üretim garantisi verir. Özel sertleştirilmiş 60 adet bıçak ve değiştirilebilir elek sistemi ile istenilen çıkış boyutu ayarlanabilir. Hidrolik itici sistem sayesinde malzemelerin rotora sürekli beslenmesi sağlanır. Manyetik bant entegrasyonu ile demir ve demir dışı metallerin ayrıştırılması kolaylaşır.',
            paragraph3: 'MT Makina RDM-100 Redmonster, küçük metal atölyeleri, hurda toplama merkezleri ve kablo geri dönüşüm tesisleri için ideal bir başlangıç yatırımıdır. Düşük enerji tüketimi ve minimum bakım gereksinimi ile işletme maliyetlerini düşürür. Dayanıklı gövde yapısı ve kaliteli bileşenleri ile uzun ömürlü kullanım sunar. CE sertifikası ve 2 yıl garanti ile desteklenir.'
        },
        en: {
