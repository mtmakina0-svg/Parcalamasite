...
export const metalDescriptions: { [modelName: string]: MultilingualModelDescription } = {
    'RDM-100': {
        tr: {
            intro: 'RDM-100 Redmonster metal parçalama makinesi, küçük ve orta ölçekli metal geri dönüşüm tesisleri için tasarlanmış kompakt, güçlü ve ekonomik bir hurda metal parçalama çözümüdür.',
            paragraph1: 'RDM-100 hurda metal parçalama makinesi, 2x45-75 kW yüksek torklu çift motor gücü ile 1000 mm rotor uzunluğu ve metal parçalama için özel tasarlanmış bıçak yapısına sahiptir. 1500-2500 kg/saat işleme kapasitesi ile alüminyum profiller, bakır kablolar, elektronik atıklar, metal talaşlar, hafif çelik atıklar ve varil parçalama uygulamalarında etkilidir. Kompakt tasarımı sayesinde dar alanlarda bile yüksek verimlilik sağlar. Düşük devir yüksek tork prensibi ile çalışan çift şaftlı yapı, metal parçalamada maksimum güç ve homojen parçalama sağlar.',
            paragraph2: 'PLC kontrollü otomasyon sistemi, otomatik sıkışma önleme özelliği, çift yönlü ters çalışma (Auto-Reverse) fonksiyonu ve aşırı yük koruması ile donatılmış RDM-100 metal parçalama makinesi, güvenli ve 7/24 kesintisiz üretim garantisi verir. Özel sertleştirilmiş 60 adet parçalı bıçak sistemi, bilenebilir ve tek tek değiştirilebilir yapısı ile uzun ömür sunar. Değiştirilebilir elek sistemi (30-100 mm) ile istenilen çıkış boyutu ayarlanabilir. Hidrolik itici sistem sayesinde malzemelerin rotora sürekli beslenmesi sağlanır.',
            paragraph3: 'MT Makina RDM-100 Redmonster serisi hurda metal parçalama makinesi, küçük metal geri dönüşüm atölyeleri, hurda toplama merkezleri, kablo geri dönüşüm tesisleri, alüminyum işleme birimleri ve belediye metal ayırma merkezleri için optimize edilmiştir. Manyetik bant entegrasyonu ile demir ve demir dışı metallerin otomatik ayrıştırılması sağlanır. Hurda demir parçalama makinası, alüminyum parçalama makinesi ve bakır parçalama makinesi uygulamalarında güvenilir performans sunar.',
            paragraph4: 'Hurda metal parçalama makinesi teknolojisi ile RDM-100, metal geri dönüşüm ve atık yönetimi süreçlerinde etkili çözümler sunar. Yüksek verimlilik, dayanıklılık ve kullanıcı dostu özellikleri ile hurda metal parçalama makinesi, metal atıkların işlenmesinde çevresel sürdürülebilirliği destekler. Modüler yapısı sayesinde konveyör besleyici, seperatör sistemleri ve elek üniteleri ile kolayca entegre edilir. Araba parçalayıcı ve beyaz eşya parçalama makinesi uygulamalarında da kullanılabilir.',
            paragraph5: 'Enerji verimliliği sunan RDM-100 metal parçalama makinesi, optimize edilmiş güç tüketimi ile işletme maliyetlerini minimize eder ve yüksek yatırım getirisi sağlar. Aşınmaya dayanıklı premium bileşenler ve otomatik yağlama sistemi sayesinde minimum bakım gerektirir. Dayanıklı gövde yapısı ve kaliteli bileşenleri ile 10+ yıl uzun ömürlü kullanım sunar. Metal parçalama makinası fiyatları ve hurda demir parçalama makinası fiyatları açısından küçük-orta ölçekli tesisler için ekonomik bir başlangıç yatırımı sunar.',
            paragraph6: 'Atık yönetiminde sürdürülebilirlik sağlayan RDM-100 Redmonster hurda metal parçalama makinesi, geri dönüşüm süreçlerini optimize ederek işletmelere yüksek verimlilik, çevresel faydalar ve ekonomik avantajlar sunar. Türkiye\'nin lider parçalama makinesi üreticisi MT Makina, metal parçalama makinesi fiyat teklifi, turnkey proje çözümleri ve teknik danışmanlık hizmetleri sunmaktadır. Hurda demir parçalama makinası fiyatları, alüminyum parçalama makinesi ve kablo geri dönüşüm projeleriniz için profesyonel danışmanlık ekibimizle iletişime geçin. CE sertifikası ve 2 yıl garanti ile desteklenir.'
        },
        en: {
            intro: 'RDM-100 Redmonster metal shredder is a compact and powerful solution for small and medium-sized metal recycling facilities.',
            paragraph1: 'RDM-100 model features 75 kW high-torque motor power with 1000 mm rotor length and special blades for metal shredding. 1500-2500 kg/hour processing capacity.',
            paragraph2: 'Equipped with PLC automation system, automatic jam prevention, RDM-100 guarantees safe production.',
            paragraph3: 'MT Makina RDM-100 is ideal for small metal workshops, scrap collection centers.'
        },
        ru: {
