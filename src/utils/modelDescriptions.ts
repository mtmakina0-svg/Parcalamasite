...
export const modelDescriptions: { [productType: string]: { [modelName: string]: ModelDescription } } = {
  ...
  'pallet': {
    'PL-800': {
      intro: 'PL-800 Palet Parçalama Makinesi, ahşap paletlerin hızlı ve verimli şekilde parçalanması için tasarlanmış güçlü bir sistemdir.',
      paragraph1: 'PL-800 model, özel tasarım bıçak sistemi ile Euro palet (1200x800 mm) ve standart paletlerin (1000x1200 mm) tek geçişte parçalanmasını sağlar. 30-45 kW motor gücü ve geniş besleme ağzı ile saatte 80-120 palet işleme kapasitesine sahiptir. Çivi ve metal parçalara karşı dayanıklı bıçak sistemi uzun ömür garantisi verir.',
      paragraph2: 'Hidrolik itici sistem, paletleri otomatik olarak parçalama bölgesine besler. Manyetik seperatör entegrasyonu ile çiviler otomatik olarak ayrıştırılır. PLC kontrol sistemi ve koruyucu muhafazalar maksimum operatör güvenliği sağlar. Parçalanan ahşap, biyokütle yakıt veya ahşap levha üretiminde kullanılabilir.',
      paragraph3: 'PL-800, lojistik firmaları, palet üretim tesisleri, geri dönüşüm merkezleri ve ahşap yakıt üretimi yapan işletmeler için idealdir. Kompakt tasarımı ve kolay bakım özellikleri ile düşük işletme maliyeti sunar. CE sertifikalı güvenlik standartları ile donatılmıştır.'
    }
  },
  'tree-root': {
    'TR-1000': {
