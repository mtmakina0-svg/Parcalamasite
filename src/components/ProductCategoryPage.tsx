...
const allModelSpecs: { [key: string]: { [model: string]: any } } = {
  ...
  'dual-shaft': {
    ...
    'CS-60': { 'Parçalama Alanı': '600 x 600 mm', 'Motor Gücü': '11–45 kW (2x)', 'Rotor Boyu': '600 mm' },
    'CS-80': { 'Parçalama Alanı': '800 x 800 mm', 'Motor Gücü': '15–55 kW (2x)', 'Rotor Boyu': '800 mm' },
    'CS-100': { 'Parçalama Alanı': '1000 x 1000 mm', 'Motor Gücü': '22–90 kW (2x)', 'Rotor Boyu': '1000 mm' },
    'CS-120': { 'Parçalama Alanı': '1200 x 1200 mm', 'Motor Gücü': '30–110 kW (2x)', 'Rotor Boyu': '1200 mm' },
    'CS-150': { 'Parçalama Alanı': '1500 x 1200 mm', 'Motor Gücü': '45–132 kW (2x)', 'Rotor Boyu': '1500 mm' },
    'CS-180': { 'Parçalama Alanı': '1800 x 1500 mm', 'Motor Gücü': '55–132 kW (2x)', 'Rotor Boyu': '1800 mm' },
...
export const ProductDetailPage = ({
  ...
  return (
    <div className="min-h-screen bg-[#F5F7F8]" dir={isRTL ? 'rtl' : 'ltr'}>
      {/* 🧠 SEO Metadata (app.tsx'e taşındı, ama burada kalması da sorun yaratmaz) */}
      <Helmet>
