...
export const Footer = () => {
  ...
  const quickLinks = [
    ...
    { key: 'nav_corporate', href: '#corporate' },
    { key: 'nav_products', href: '#products' },
    { key: 'nav_technology', href: '#technology' },
    { key: 'nav_references', href: '#references' },
      ...
      <div className="container mx-auto px-4 lg:px-8 max-w-[1440px] relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-16">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              >
                ...
                <a 
                  href="https://maps.app.goo.gl/D7UQ1IAJUmzeuxY0n"
                  target="_blank"
              ...
              >
                ...
                <a 
                  href="mailto:info@mtmakina.com.tr"
                  className="text-sm text-[#F5F7F8]/80 group-hover:text-[#F4CE14] transition-colors"
                >
                  {t('footer_full_email')}
                </a>
          ...
          >
            ...
            >
              <a 
                href="https://www.mtmakina.com.tr" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-sm text-[#F5F7F8]/80 hover:text-[#F4CE14] transition-colors inline-block"
              >
