...
const translations = {
  tr: {
    ...
    single_shaft_faq_q4: 'BAKIM GEREKSİNİMLER�� NELERDİR?',
  ...
  ar: {
    ...
    ref_main_title: 'رضا العم��اء وقصص النجاح',
    ...
    single_saft_faq_q3: 'كيف تعمل آلات التقطيع أحادية ��لعمود؟',
