    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="references-grid">
                ...
                <div class="reference-logo"><img src="../../assets/referanslar/tav-havalimanlari-logo.webp" alt="TAV Havalimanları"></div>
                ...
                <div class="reference-logo"><img src="../../assets/referanslar/genelkurmay-baskanligi-logo.webp" alt="Genelkurmay Başkanlığı"></div>
                <!-- Satır 4 -->
                ...
                <div class="reference-logo"><img src="../../assets/referanslar/max-royal-resort-logo.webp" alt="Max Royal Resort"></div>
                ...
                <div class="reference-logo"><img src="../../assets/referanslar/malatya-buyuksehir-belediyesi-logo.webp" alt="Malatya Büyükşehir Belediyesi"></div>
            ...
            <div class="highlight-box" style="margin-top:8mm">
                <h3>${lang === 'tr' ? 'Güvenilir Çözüm Ortağınız' : lang === 'en' ? 'Your Reliable Solution Partner' : lang === 'ru' ? 'Ваш Надежный Партнер' : 'شريكك الموثوق للحلول'}</h3>
                <p>${lang === 'tr' ? '20 yılı aşkın tecrübemizle kamu kurumları, özel sektör ve uluslararası firmalar için endüstriyel parçalama çözümleri sunuyoruz.' : lang === 'en' ? 'With over 20 years of experience, we provide industrial shredding solutions for public institutions, private sector and international companies.' : lang === 'ru' ? 'Более 20 лет опыта в предоставлении промышленных решений для государственных учреждений, частного сектора и международных компаний.' : 'مع أكثر من 20 عامًا من الخبرة، نقدم حلول التمزيق الصناعي للمؤسسات العامة والقطاع الخاص والشركات الدولية.'}</p>
            </div>
        </div>
