/**
 * Metal Shredder (RDM Series) 7-Page HTML Template Generator
...
// Sayfa metinleri
const pageTexts = {
    metalShredder: { tr: 'Metal Parçalama Makinesi', en: 'Metal Shredder', ru: 'Измельчитель Металла', ar: 'كسارة المعادن' },
    ...
    rdmSeries: { tr: 'RDM Serisi', en: 'RDM Series', ru: 'Серия RDM', ar: 'سلسلة RDM' }
};

export function generateMetalHTML(modelId: string, lang: string, model: any, langConfig: LanguageConfig): string {
...
<head>
    ...
    <base href="/catalogs/metal/${modelId}/">
    <title>${modelName} ${pageTexts.metalShredder[lang as keyof typeof pageTexts.metalShredder]} | MT Makina</title>
    <meta name="description" content="${model.description[lang]}">
    <meta name="keywords" content="${modelName}, metal shredder, metal parçalama, çift şaftlı, MT Makina, RDM serisi, hurda parçalama">
    <meta name="robots" content="index, follow, max-image-preview:large">
    <meta name="author" content="MT Makina">
    <link rel="canonical" href="https://www.parcalamamakinesi.com/catalogs/metal/${modelId}/catalog${langConfig.suffix}.html">
    <meta property="og:type" content="product">
    <meta property="og:url" content="https://www.parcalamamakinesi.com/catalogs/metal/${modelId}/catalog${langConfig.suffix}.html">
    <meta property="og:title" content="${modelName} ${pageTexts.metalShredder[lang as keyof typeof pageTexts.metalShredder]} | MT Makina">
...
<body>
    ...
    <div class="page">
        <div class="cover-page">
            ...
            <div class="cover-content">
                <img src="images/${img1}" alt="${modelName} ${pageTexts.metalShredder[lang as keyof typeof pageTexts.metalShredder]}" class="cover-img">
                <h1 class="cover-model">${modelName}</h1>
                <p class="cover-title">${pageTexts.metalShredder[lang as keyof typeof pageTexts.metalShredder]}</p>
                <p class="cover-subtitle">${pageTexts.rdmSeries[lang as keyof typeof pageTexts.rdmSeries]} | ${pageTexts.dualShaft[lang as keyof typeof pageTexts.dualShaft]}</p>
    ...
    <div class="page">
        <div class="page-content">
            ...
            <p>${modelName}, ${lang === 'tr' ? 'çift şaftlı tasarımı sayesinde metal geri dönüşüm sektöründe aşağıdaki alanlarda tercih edilmektedir:' : lang === 'en' ? 'is preferred in the following areas of the metal recycling industry with its dual-shaft design:' : lang === 'ru' ? 'благодаря двухвальной конструкции предпочтителен в следующих областях металлоперерабатывающей отрасли:' : 'مفضل في المجالات التالية من صناعة إعادة تدوير المعادن بتصميمها ثنائي العمود:'}</p>
            ...
            <div class="highlight-box" style="margin-top:6mm;text-align:center">
                ...
                <p>• ${lang === 'tr' ? 'Çift şaftlı kontrollü parçalama' : lang === 'en' ? 'Dual-shaft controlled shredding' : lang === 'ru' ? 'Контролируемое двухвальное измельчение' : 'تمزيق متحكم ثنائي العمود'} &nbsp;&nbsp;• ${lang === 'tr' ? 'Yüksek işleme kapasitesi' : lang === 'en' ? 'High processing capacity' : lang === 'ru' ? 'Высокая производительность' : 'قدرة معالجة عالية'} &nbsp;&nbsp;• ${lang === 'tr' ? 'Düşük bakım maliyeti' : lang === 'en' ? 'Low maintenance cost' : lang === 'ru' ? 'Низкие затраты на обслуживание' : 'تكلفة صيانة منخفضة'}<br>• ${lang === 'tr' ? 'Hardox 500 bıçaklar' : lang === 'en' ? 'Hardox 500 blades' : lang === 'ru' ? 'Ножи Hardox 500' : 'شفرات Hardox 500'} &nbsp;&nbsp;• ${lang === 'tr' ? 'Modüler tasarım' : lang === 'en' ? 'Modular design' : lang === 'ru' ? 'Модульная конструкция' : 'تصميم معياري'}</p>
            </div>
            ...
            <div class="two-columns" style="margin-top:6mm">
                <div class="column">
                    ...
                    <ul class="specs-list">
                        ...
                        <li><span class="spec-label">${lang === 'tr' ? 'Tahrik Sistemi' : lang === 'en' ? 'Drive System' : lang === 'ru' ? 'Привод' : 'نظام القيادة'}</span><span class="spec-value">${lang === 'tr' ? 'Elektrik Motor + Redüktör' : lang === 'en' ? 'Electric Motor + Gearbox' : lang === 'ru' ? 'Электродвигатель + Редуктор' : 'محرك كهربائي + علبة تروس'}</span></li>
    ...
    <div class="page">
        <div class="page-content">
            ...
            <div style="text-align:center;margin-bottom:6mm">
                ...
                <p style="font-size:12pt;color:#666;margin-top:3mm">${pageTexts.metalShredder[lang as keyof typeof pageTexts.metalShredder]} | ${pageTexts.dualShaft[lang as keyof typeof pageTexts.dualShaft]}</p>
            </div>
            ...
            <div class="spec-card">
                ...
                <div class="spec-row"><span class="label">${pageTexts.design[lang as keyof typeof pageTexts.design]}</span><span class="value">${pageTexts.dualShaft[lang as keyof typeof pageTexts.dualShaft]}</span></div>
    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="highlight-box" style="margin-top:8mm">
                ...
                <p>${lang === 'tr' ? '20 yılı aşkın tecrübemizle metal geri dönüşüm sektörüne endüstriyel parçalama çözümleri sunuyoruz. Hurda tesisleri, çelik fabrikaları ve geri dönüşüm merkezleri için özel çözümler üretiyoruz.' : lang === 'en' ? 'With over 20 years of experience, we provide industrial shredding solutions to the metal recycling industry. We produce custom solutions for scrap facilities, steel mills, and recycling centers.' : lang === 'ru' ? 'С более чем 20-летним опытом мы предоставляем промышленные решения для измельчения в металлоперерабатывающей отрасли. Мы производим индивидуальные решения для ломозаготовительных предприятий, сталелитейных заводов и центров переработки.' : 'مع أكثر من 20 عامًا من الخبرة، نقدم حلول التمزيق الصناعي لصناعة إعادة تدوير المعادن. ننتج حلولاً مخصصة لمرافق الخردة ومصانع الصلب ومراكز إعادة التدوير.'}</p>
            </div>
        </div>
